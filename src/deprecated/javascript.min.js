...
Modernizr.touchevents&&(l=e(l).find(".clearing-touch-label").html(c).end()),o.after(l).remove()}}},open:function(t,i,r){function o(){setTimeout(function(){this.image_loaded(f,function(){1!==f.outerWidth()||p?s.call(this,f):o.call(this)}.bind(this))}.bind(this),100)}function s(t){var n=e(t)
...
r(this.scope).off(".dropdown").on("click.fndtn.dropdown","["+this.attr_name()+"]",function(t){var n=r(this).data(i.attr_name(!0)+"-init")||i.settings;(!n.is_hover||Modernizr.touchevents)&&(t.preventDefault(),r(this).parent("[data-reveal-id]")&&t.stopPropagation(),i.toggle(e(this)))}).on("mouseenter.fndtn.dropdown","["+this.attr_name()+"], ["+this.attr_name()+"-content]",function(e){var t,n,o=r(this)

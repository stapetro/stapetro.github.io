...
{% include alert text='Ако сте заредили веднъж страницата, след това може да теглите късмети дори и без интернет връзка.' %}
...
<script type="module">
  import {NoteViewer} from '/assets/js/pickLuck.js';
